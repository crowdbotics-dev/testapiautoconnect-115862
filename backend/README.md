...
## Project Structure
    ...
    ├── testapiautoconnect_115862  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115862`
...
2. Clone this repo and `cd testapiautoconnect_115862`
